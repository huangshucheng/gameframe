...
M.CardDefine = {
    ...
    0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, -- 东、南、西、北、中、发、白 49-55
    0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47, 0x48, -- 春夏秋冬梅兰竹菊 65-72
}

M.COLOR_WAN     = 0x10 --万 16
M.COLOR_TONG    = 0x20 --条 32
M.COLOR_TIAO    = 0x30 --筒 48
M.COLOR_ZI      = 0x40 --字 64
M.COLOR_HUA     = 0x50 --花 80
...
function M.can_chi(hand_cards, card1, card2)
    ...
    local color1 = M.CardDefine[hand_cards[card1]] & 0xf0
    local color2 = M.CardDefine[hand_cards[card2]] & 0xf0
