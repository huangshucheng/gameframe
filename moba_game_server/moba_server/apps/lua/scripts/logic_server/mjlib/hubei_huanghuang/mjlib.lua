...
local wave_table = require "logic_server/mjlib/hubei_huanghuang/auto_table"
local wave_table_eye = require "logic_server/mjlib/hubei_huanghuang/auto_table_with_eye"
