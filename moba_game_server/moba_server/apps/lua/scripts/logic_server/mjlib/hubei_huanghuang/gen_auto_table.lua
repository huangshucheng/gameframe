...
local auto_tbl = require "logic_server/mjlib/hubei_huanghuang/auto_table"
local utils = require "logic_server/mjlibutils"
local mjlib = require "logic_server/mjlib/hubei_huanghuang/mjlib"
