...
local wave_table = require "logic_server/mjlib/gui/auto_table"
local wave_table_eye = require "logic_server/mjlib/gui/auto_table_with_eye"
local mjlib = require "logic_server/mjlib/gui/mjlib"
